                                    ...
                                    <div className="col-12">
                                        <div className="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div className="flex-grow-1">
                                                <h4 className="fs-16 mb-1">Good Morning, iamLeb!</h4>
                                            ...
                                            <div className="acitivity-timeline acitivity-main">
                                                <div className="acitivity-item d-flex">
                                                    <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                                        <div
                                                            className="avatar-title bg-success-subtle text-success rounded-circle shadow">
                                                ...
                                                <div className="acitivity-item py-3 d-flex">
                                                    <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                                        <div
                                                            className="avatar-title bg-danger-subtle text-danger rounded-circle shadow">
                                                ...
                                                <div className="acitivity-item py-3 d-flex">
                                                    <div className="flex-shrink-0">
                                                        <div className="avatar-xs acitivity-avatar">
                                                            <div
                                                                className="avatar-title rounded-circle bg-secondary shadow">
                                                            ...
                                                            <div className="card-body">
                                                                <div className="d-flex">
                                                                    <div className="flex-shrink-0 avatar-sm">
                                                                        <div
                                                                            className="avatar-title bg-light rounded shadow">
                                                                            <img
                                                                                src="assets/images/companies/img-1.png"
                                                                                alt=""
                                                                                height={30}
                                            ...
                                            <div className="mt-3">
                                                <div className="row align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div
                                                                className="progress bg-success-subtle animated-progress progress-sm">
                                                                <div
                                                ...
                                                <div className="row align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div
                                                                className="progress bg-warning-subtle animated-progress progress-sm">
                                                                <div
                                                ...
                                                <div className="row align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div
                                                                className="progress bg-danger-subtle animated-progress progress-sm">
                                                                <div
